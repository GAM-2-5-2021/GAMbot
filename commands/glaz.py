...
# Pretvara čudnu listu riječi u dict(), koristi sličan način kao i lat.py
rjecnik = dict()
...
class glaz(commands.Cog, name='glaz'):
	...
	async def glaz(self, ctx, str=None):
		"""
		Ponavljanje za odgovaranje iz glazbenog
		- ispisuje natuknice za uneseno razdoblje
		"""
		if not str:
